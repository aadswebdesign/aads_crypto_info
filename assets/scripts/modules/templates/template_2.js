...
export async function templateTwo(){
	const template = `<div id='templateTwo' class='template-two relative'>
			...
			<article class='disclaimer relative'>
				...
				<h3>Belangrijk advies!</h3>
				<p class='ltr-arrow relative'>Zorg ervoor dat u begrijpt wat u doet.</p>
				<p class='ltr-arrow relative'>Investeer alleen met geld dat u zich kunt veroorloven.</p>
			...
			<hr/>
			<header class='relative'><h2>De stappen naar een passief inkomen.</h2></header>
			<article class='relative'>
				...
				<p>Eén van de projecten is CPGames en deze zal de waarde van de CPCoin een grote impuls gaan geven!</p>
				<p class='padding-one quoted-double relative' style='color:#7e7e7e'>
					Leuk om te weten is dat ze een belangrijke prijs hebben gewonnen op de prestigieuze <a target='blanc' href='https://fb.watch/ooW4fczH_G/' class='a-underline'>Sigma - Europes Ultimate Gaming Expo</a> in Malta.
				</p>
				<p>Dit is slechts een van de projecten die op de CPCoin gaan draaien en er zullen er nog veel meer volgen!</p>
				<p>Feit is dat al deze projecten ervoor zullen gaan zorgen dat de waarde van de CPCoin zeer sterk zal gaan stijgen!</p>
				<h3>Feiten over dit blockchainbedrijf!</h3>
				<p>Alles wat ze doen is gebaseerd op transparantie, eerlijkheid en volgens de wet.</p>
				<p>Daarom hebben ze geen haast bij om dingen gedaan te krijgen en willen ze niet te snel, maar stap voor stap groeien.</p>
				<p>Ze willen gewoon de dingen op de juiste manier doen en dat kost tijd.</p>
				...
				<p>Ja, dit maakte voor mij duidelijk dat het geen oplichterij was, maar een betrouwbare manier om een passief inkomen te creëren.</p>
				<p>Dit gaf mij de motivatie om me in te schrijven en wat kleine investeringen te doen.</p>
				...
				<p class='ltr-arrow relative'>In-/uitschrijven bij dit blockchainbedrijf is gratis en kan op elk moment.</p>
			</article>
			<hr/>
			<article class='relative'>
				<header class='relative'><h2>Nawoord.</h2></header>
				...
				<p class='ltr-arrow relative'>Wat kan je doen om passief inkomen te vormen.</p>
				<p class='ltr-arrow relative'>Wat is de potentie van de eigen CP Coin als mogelijke geldgenerator.</p>
				<p class='ltr-arrow relative'>Korte toelichting op de projecten die op de blockchain gaan draaien en die de meerwaarde van de CPCoin gaan stuwen.</p>
				<p class='ltr-arrow relative'>Een actuele update over de huidige stand van zaken.</p>
				<p>Uiteraard, als je ingeschreven bent krijg je van mij een link om zo'n webinar bij te wonen!</p>
			</article>
			<hr/>
